...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (com.chad.library.adapter.base.BaseQuickAdapter) recyclerView.getAdapter();
     ...
     */
    public abstract void onItemClick(com.chad.library.adapter.base.BaseQuickAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(com.chad.library.adapter.base.BaseQuickAdapter adapter, View view, int position);
    /**
     ...
     * @return true if the callback consumed the long click ,false otherwise
     */
    public abstract void onItemChildClick(com.chad.library.adapter.base.BaseQuickAdapter adapter, View view, int position);
    /**
     * callback method to be invoked when an item in this view has been
     * click and held
     * @param adapter
     ...
     * @return true if the callback consumed the long click ,false otherwise
     */
    public abstract void onItemChildLongClick(com.chad.library.adapter.base.BaseQuickAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter == null) {
            if (recyclerView != null) {
                baseQuickAdapter = (com.chad.library.adapter.base.BaseQuickAdapter) recyclerView.getAdapter();
            } else {
                return false;
            }
        }
        int type = baseQuickAdapter.getItemViewType(position);
        return (type == com.chad.library.adapter.base.BaseQuickAdapter.EMPTY_VIEW || type == com.chad.library.adapter.base.BaseQuickAdapter.HEADER_VIEW || type == com.chad.library.adapter.base.BaseQuickAdapter.FOOTER_VIEW || type == com.chad.library.adapter.base.BaseQuickAdapter.LOADING_VIEW);
    }
