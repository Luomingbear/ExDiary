...
//    private static final String TAG = ItemDragAndSwipeCallback.class.getSimpleName();
    ...
    private boolean isViewCreateByAdapter(@NonNull RecyclerView.ViewHolder viewHolder) {
        ...
        return type == com.chad.library.adapter.base.BaseQuickAdapter.HEADER_VIEW || type == com.chad.library.adapter.base.BaseQuickAdapter.LOADING_VIEW
                || type == com.chad.library.adapter.base.BaseQuickAdapter.FOOTER_VIEW || type == BaseQuickAdapter.EMPTY_VIEW;
    }
}
