 ...
 */
public abstract class BaseQuickAdapter<T, K extends com.chad.library.adapter.base.BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private void bindViewClickListener(final com.chad.library.adapter.base.BaseViewHolder baseViewHolder) {
    ...
    protected K createBaseViewHolder(View view) {
        ...
        // 泛型擦除会导致z为null
        if (z == null) {
            k = (K) new com.chad.library.adapter.base.BaseViewHolder(view);
        } else {
            k = createGenericKInstance(z, view);
        }
        return k != null ? k : (K) new com.chad.library.adapter.base.BaseViewHolder(view);
    }
        ...
        if (type instanceof ParameterizedType) {
            ...
            for (Type temp : types) {
                if (temp instanceof Class) {
                    ...
                    if (rawType instanceof Class && com.chad.library.adapter.base.BaseViewHolder.class.isAssignableFrom((Class<?>) rawType)) {
    ...
    public View getViewByPosition(RecyclerView recyclerView, int position, @IdRes int viewId) {
        ...
        com.chad.library.adapter.base.BaseViewHolder viewHolder = (BaseViewHolder) recyclerView.findViewHolderForLayoutPosition(position);
        if (viewHolder == null) {
            return null;
        }
